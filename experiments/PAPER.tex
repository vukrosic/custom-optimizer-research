...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{images/routing_distribution.png}
...
\begin{enumerate}
    \item \textbf{Punctuation \& Structural Tokens:} Tokens like periods, commas, and the initial ``The'' consistently route to Softmax in Layer 1. This suggests the model uses full attention for structural tokens that may require global context awareness.
    
    \item \textbf{Content Words:} Nouns and verbs (``fox'', ``jumps'', ``equations'', ``mechanics'') often route to Linear attention in Layer 1, relying on the efficient mechanism for straightforward content representation.
