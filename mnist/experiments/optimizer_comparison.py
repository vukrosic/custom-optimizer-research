...
Systematically compare all optimizers on MNIST:
- AdamW (baseline)
...
from mnist.common.data import set_seed, get_mnist_loaders, get_device
from mnist.common.models import MNISTNet
from mnist.common.metrics import effective_rank
...
def plot_comparison(results, save_path='optimizer_comparison.png'):
    ...
    plt.suptitle('Optimizer Comparison on MNIST', fontsize=14, fontweight='bold')
    plt.tight_layout()
