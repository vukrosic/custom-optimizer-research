"""
LLM Experiment: AdamW vs Muon with Newton-Schulz Iteration Analysis

This experiment:
1. Compares AdamW vs Muon optimizers on LLM
...
def plot_comparison(results, save_prefix='llm_comparison'):
    ...
    plt.suptitle('LLM Experiment: AdamW vs Muon (3 vs 5 NS iterations)', fontsize=14, fontweight='bold')
    plt.tight_layout()
...
def print_summary(results):
    ...
    print("\n" + "="*70)
    print("EXPERIMENT SUMMARY: LLM - AdamW vs Muon (3 vs 5 NS iterations)")
    print("="*70)
...
def main():
    parser = argparse.ArgumentParser(description='LLM: AdamW vs Muon with NS iteration analysis')
    ...
    # Plotting
    print("\n📊 Generating plots...")
    plot_comparison(results, save_prefix='llm_comparison')
